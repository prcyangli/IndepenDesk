...
internal static class L
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Tables = new()
    {
        ["en"] = new()
        {
            ...
            ["menu.taskbarJump"] = "Jump to the desktop of a taskbar-activated window",
            ...
            ["msg.restoreConfirm"] = "This shows every hidden window and merges all desktops of each monitor into its first desktop. Continue?",
            ...
            ["ov.menu.moveNew"] = "Move to:  Monitor {0}  •  New desktop",
        ...
        ["tr"] = new()
        {
            ...
            ["menu.taskbarJump"] = "Görev çubuğu etkinleştirmesinde pencerenin masaüstüne geç",
            ...
            ["msg.restoreConfirm"] = "Bu işlem gizli tüm pencereleri gösterir ve her monitörün tüm masaüstlerini ilk masaüstünde birleştirir. Devam edilsin mi?",
            ...
            ["ov.menu.moveNew"] = "Taşı:  Monitör {0}  •  Yeni masaüstü",
        ...
        ["de"] = new()
        {
            ...
            ["menu.taskbarJump"] = "Bei Taskleisten-Aktivierung zum Desktop des Fensters wechseln",
            ...
            ["msg.restoreConfirm"] = "Dadurch werden alle ausgeblendeten Fenster angezeigt und alle Desktops jedes Monitors im ersten Desktop zusammengeführt. Fortfahren?",
            ...
            ["ov.menu.moveNew"] = "Verschieben:  Monitor {0}  •  Neuer Desktop",
        ...
        ["fr"] = new()
        {
            ...
            ["menu.taskbarJump"] = "Aller au bureau de la fenêtre activée depuis la barre des tâches",
            ...
            ["msg.restoreConfirm"] = "Cela affichera toutes les fenêtres masquées et fusionnera tous les bureaux de chaque moniteur dans le premier. Continuer ?",
            ...
            ["ov.menu.moveNew"] = "Déplacer vers :  Moniteur {0}  •  Nouveau bureau",
        ...
        ["it"] = new()
        {
            ...
            ["menu.taskbarJump"] = "Vai al desktop della finestra attivata dalla barra delle applicazioni",
            ...
            ["msg.restoreConfirm"] = "Verranno mostrate tutte le finestre nascoste e tutti i desktop di ogni monitor verranno uniti al primo. Continuare?",
            ...
            ["ov.menu.moveNew"] = "Sposta in:  Monitor {0}  •  Nuovo desktop",
        ...
        ["ru"] = new()
        {
            ...
            ["menu.taskbarJump"] = "Переходить к рабочему столу окна, активированного из панели задач",
            ...
            ["msg.restoreConfirm"] = "Будут показаны все скрытые окна, а все рабочие столы каждого монитора объединятся в первый. Продолжить?",
            ...
            ["ov.menu.moveNew"] = "Переместить:  Монитор {0}  •  Новый рабочий стол",
        ...
        ["zh"] = new()
        {
            ...
            ["menu.taskbarJump"] = "任务栏激活时跳转到窗口所在桌面",
            ...
            ["msg.restoreConfirm"] = "这将显示所有隐藏窗口，并把每个显示器的全部桌面合并到桌面 1。是否继续？",
            ...
            ["ov.menu.moveNew"] = "移动到：显示器 {0}  •  新建桌面",
        ...
        ["ja"] = new()
        {
            ...
            ["menu.taskbarJump"] = "タスクバーで起動したウィンドウのデスクトップへ移動",
            ...
            ["msg.restoreConfirm"] = "非表示のすべてのウィンドウを表示し、各モニターのすべてのデスクトップをデスクトップ 1 に統合します。続行しますか？",
            ...
            ["ov.menu.moveNew"] = "移動:  モニター {0}  •  新しいデスクトップ",
